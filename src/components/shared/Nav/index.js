...
const Nav = ({totalPrice, numberItemsBag, numberItemsWishlist}) => {
        ...
        <header className="header container">
            ...
            <aside className="header-bag">   
                ...
                <div className="header-bag__item header-bag__count">
                    ...
                    <span className="bag__item-counter">{numberItemsBag}</span>
                </div>
                </Link>
                <div className="header-bag__item header-bag__wishlist-count">
                    ...
                    <span className="bag__item-counter">{numberItemsWishlist}</span>
                </div>
            </aside >
        </header >
